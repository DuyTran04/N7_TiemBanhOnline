        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="rating">
                        <span>Lượng đánh giá:</span><span style="color: #ffc107">
                    ...
                    <ul class="pro-info-list">
                        ...
                        <li><span>Trạng thái: </span>Trong kho</li>
                        <li><span>Mã bánh: </span> BK<?= $pro["id"] ?>
                        </li>
                        <li><span>Brand: </span>TiemBanh</li>
                    </ul>
                    ...
                    <div class="product__details__more">
                        <div class="tag"> <span class="more-title">Tag: </span>
                            <ul>
                                ...
                                <li><a href="#">bánh kem</a><span> ,</span></li>
                            </ul>
                        </div>
                        <div class="category"> <span class="more-title">Loại bánh: </span>
                            <ul>
                            ...
                            <div class="rev-form">
                                ...
                                <form method="POST" class="review-form"
                                    ...
                                    <label for="stars" style="width: 13%;padding-right: 20px;">
                                        Đánh giá <span class="asterisk">*</span>
                                    </label>
                                    <div class="rating">
                                    ...
                                    <div class="form-group">
                                        <label for="content">Mô tả đánh giá <span class="asterisk">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="">Địa chỉ Email <span class="asterisk">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for=""></label>
                                        <button type="submit" class="rev-btn">Gửi đánh giá</button>
                                    </div>
